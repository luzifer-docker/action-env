FROM debian:13.6-slim@sha256:3a39a0592364683e6bab97937b72cad5a8fa6dcbbee90edb3bb48c7f8e94f258 AS base
...
ARG GOLANG_VERSION=1.26.6  # renovate: packageName=golang datasource=golang-version
...
ARG SYFT_VERSION=1.51.0  # renovate: packageName=anchore/syft datasource=github-releases
...
COPY --from=ghcr.io/astral-sh/uv:0.12.4@sha256:d0a6eca6c669dc7e9c51218707b8438a3d30402733d739dcc00adb3e213e8f5c \
  /uv /uvx \
...
COPY --from=ghcr.io/luzifer-docker/kubectl:v1.36.3@sha256:f6e36dd2a3384ed22180f494488159a0cae754e4ab7e9e18b8d53e8166ea1602 \
