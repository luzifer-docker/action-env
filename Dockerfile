...
ARG NODE_VERSION=24.18.1  # renovate: packageName=node datasource=node-version
...
COPY --from=ghcr.io/astral-sh/uv:0.12.2@sha256:069a51314a7bb6031777a9273205fe1b0b19e914ef418207d1338b268df641dd \
  /uv /uvx \
